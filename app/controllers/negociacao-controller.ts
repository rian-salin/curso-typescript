...
export class NegociacaoController {
  private inputData: HTMLInputElement; //tipagem para dizer que é input html
  private inputQuantidade: HTMLInputElement; //tipagem para dizer que é input html
  private inputValor: HTMLInputElement; //tipagem para dizer que é input html
